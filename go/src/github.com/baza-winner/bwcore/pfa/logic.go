...
func ParseLogic(p runeprovider.RuneProvider) (data interface{}, errinitialState error) {
	...
	// 		[]interface{}{SecondaryIs{"waitForSpace"}, IsUnicodeSpace, SetSecondary{"waitForNonSpace"}},
	// 		[]interface{}{SecondaryIs{"waitForNonSpace"}, IsUnicodeSpace},
	...
	// 		[]interface{}{PrimaryIs{"start"}, IsUnicodeLower,
	// 			SetState{"entityId", ""}, PushItem{}, SetTopItemType{"key"}, AppendCurrRune{},
	// 		},
	// 		[]interface{}{PrimaryIs{"entityId"}, IsUnicodeLetter, IsUnicodeDigit,
	// 			AppendCurrRune{},
	// 		},
	...
	// 		},
	// 		[]interface{}{StateIs{"rule", "waitForNonSpace"}, IsUnicodeUpper,
	// 			PushItem{}, SetTopItemType{"ruleItem"}, AppendCurrRune{}, SetSecondary{"name"},
	// 		},
	// 		[]interface{}{StateIs{"rule", "name"}, IsUnicodeLetter, IsUnicodeDigit,
	// 			AppendCurrRune{},
	// 		},
	...
	// 		},
	// 		[]interface{}{StateIs{"ruleItem", "waitForNonSpace"}, IsUnicodeUpper,
	// 			SetState{"ruleItem", "waitForSpaceOr}"},
	// 		},
	// 		[]interface{}{StateIs{"ruleItem", "waitForSpaceOr}"}, IsUnicodeSpace, '}', TopItemStringIs{"SetError"},
