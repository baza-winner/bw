// Code generated by "bwsetter -type=Item"; DO NOT EDIT; bwsetter: go get -type=Item -set=Set -omitprefix%!(EXTRA string=github.com/baza-winner/bwcore/bwsetter)
...
func (v Set) DataForJSON() interface{} {
	result := []interface{}{}
	for k, _ := range v {
