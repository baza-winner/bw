...
func (v Set) _AddTestHelper(kk ...Item) Set {
	result := v.Copy()
	result.Add(kk...)
	return result
}
...
func (v Set) _AddSliceTestHelper(kk []Item) Set {
	result := v.Copy()
	result.AddSlice(kk)
	return result
}
...
func (v Set) _AddSetTestHelper(s Set) Set {
	result := v.Copy()
	result.AddSet(s)
	return result
}
...
func (v Set) _DelTestHelper(kk ...Item) Set {
	result := v.Copy()
	result.Del(kk...)
	return result
}
...
func (v Set) _DelSliceTestHelper(kk []Item) Set {
	result := v.Copy()
	result.DelSlice(kk)
	return result
}
...
func (v Set) _DelSetTestHelper(s Set) Set {
	result := v.Copy()
	result.DelSet(s)
	return result
}
