				...
				[]interface{}{VarIs{"0.string", "qw"},
					...
					SubRules{CreateRules(
						[]interface{}{IsUnicodeOpenBraces, IsUnicodePunct, IsUnicodeSymbol,
							...
							// SetVarBy{"0.delimiter", Var{"currRune"}, []interface{PairForCurrRune{}}},
							SubRules{CreateRules(
								[]interface{}{'<', SetVar{"0.delimiter", '>'}},
								[]interface{}{'[', SetVar{"0.delimiter", ']'}},
								[]interface{}{'(', SetVar{"0.delimiter", ')'}},
								[]interface{}{'{', SetVar{"0.delimiter", '}'}},
								[]interface{}{SetVar{"0.delimiter", Var{"currRune"}}},
							)},
	...
	primaryStateLogic := CreateRules(
		...
		[]interface{}{VarIs{"primary", "expectWord"},
			SubRules{CreateRules(
				[]interface{}{IsUnicodeLetter, IsUnicodeDigit,
					SetVarBy{"0.string", Var{"currRune"}, By{Append{}}},
					// AppendToVar{"0.string", Var{"currRune"}},
				},
				[]interface{}{
					PushRune{},
		...
		[]interface{}{VarIs{"primary", "expectSpaceOrQwItemOrDelimiter"},
			SubRules{CreateRules(
				unexpectedEOF,
				[]interface{}{IsUnicodeSpace},
				[]interface{}{VarIs{"currRune", Var{"0.delimiter"}},
					SetVar{"needFinish", true},
				},
				[]interface{}{
					PushItem{},
		...
		[]interface{}{VarIs{"primary", "expectEndOfQwItem"},
			SubRules{CreateRules(
				unexpectedEOF,
				[]interface{}{IsUnicodeSpace, VarIs{"currRune", Var{"0.delimiter"}},
					PushRune{},
					SetVar{"needFinish", true},
				},
				[]interface{}{
		...
		[]interface{}{VarIs{"primary", "expectContentOf"},
			SubRules{CreateRules(
				unexpectedEOF,
				[]interface{}{VarIs{"currRune", Var{"0.delimiter"}},
					// VarIs{"currRune", Var{"0.delimiter"}},
					SetVar{"needFinish", true},
				},
				[]interface{}{'\\',
		...
		[]interface{}{VarIs{"primary", "expectDigit"},
			SubRules{CreateRules(
				[]interface{}{IsUnicodeDigit, VarIs{"secondary", ""},
					SetVarBy{"0.string", Var{"currRune"}, By{Append{}}},
					// AppendToVar{"0.string", Var{"currRune"}},
				...
				[]interface{}{'_', IsUnicodeDigit, VarIs{"secondary", "orUnderscoreOrDot"}, VarIs{"secondary", "orUnderscore"},
					SetVarBy{"0.string", Var{"currRune"}, By{Append{}}},
					// AppendToVar{"0.string", Var{"currRune"}},
				},
		...
		[]interface{}{VarIs{"primary", "expectSpaceOrMapKey"},
			SubRules{CreateRules(
				...
				[]interface{}{'"', '\'',
					PushItem{},
					SetVar{"0.type", "key"},
					SetVar{"0.delimiter", Var{"currRune"}},
				...
				[]interface{}{VarIs{"currRune", Var{"0.delimiter"}}, VarIs{"0.type", "map"},
					SetVar{"needFinish", true},
				},
				unexpectedRune,
			)},
		...
		[]interface{}{VarIs{"primary", "begin"},
			SubRules{CreateRules(
				...
				[]interface{}{VarIs{"0.type", "array"}, VarIs{"currRune", Var{"0.delimiter"}},
					SetVar{"needFinish", true},
				},
				[]interface{}{'-', '+',
					PushItem{},
