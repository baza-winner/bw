// Code generated by "bwsetter -type=parseStackItemType"; DO NOT EDIT; bwsetter: go get -type=parseStackItemType%!(EXTRA string=github.com/baza-winner/bwcore/bwsetter)
...
func (v parseStackItemTypeSet) DataForJson() interface{} {
	result := []interface{}{}
	for k, _ := range v {
