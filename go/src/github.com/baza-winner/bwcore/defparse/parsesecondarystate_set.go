// Code generated by "bwsetter -type=parseSecondaryState"; DO NOT EDIT; bwsetter: go get -type=parseSecondaryState%!(EXTRA string=github.com/baza-winner/bwcore/bwsetter)
...
func (v parseSecondaryStateSet) DataForJson() interface{} {
	result := []interface{}{}
	for k, _ := range v {
