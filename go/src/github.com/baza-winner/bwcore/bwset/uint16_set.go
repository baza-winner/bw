...
// Uint16 - множество значений типа uint16 с поддержкой интерфейсов Stringer и github.com/baza-winner/bwcore/bwjson.Jsonable
...
func (v Uint16) DataForJSON() interface{} {
	result := []interface{}{}
	for k, _ := range v {
		result = append(result, k)
	}
