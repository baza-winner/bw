// Code generated by "setter -type=int8"; DO NOT EDIT; setter: go get github.com/baza-winner/bwcore/setter
...
func TestInt8Set(t *testing.T) {
	...
	bwtesting.BwRunTests(t, Int8Set.String, map[string]bwtesting.TestCaseStruct{"Int8Set.String": {
		In:  []interface{}{Int8Set{_Int8SetTestItemA: struct{}{}}},
		Out: []interface{}{fmt.Sprintf("[\n  %q\n]", strconv.FormatInt(int64(_Int8SetTestItemA), 10))},
	}})
	bwtesting.BwRunTests(t, Int8Set.GetDataForJson, map[string]bwtesting.TestCaseStruct{"Int8Set.GetDataForJson": {
		In:  []interface{}{Int8Set{_Int8SetTestItemA: struct{}{}}},
		Out: []interface{}{[]interface{}{strconv.FormatInt(int64(_Int8SetTestItemA), 10)}},
	}})
