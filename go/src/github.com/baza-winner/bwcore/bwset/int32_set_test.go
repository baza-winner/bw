// Code generated by "bwsetter -type=int32"; DO NOT EDIT; bwsetter: go get -type=int32 -set=Int32Set -test%!(EXTRA string=github.com/baza-winner/bwcore/bwsetter)
...
func TestInt32Set(t *testing.T) {
	...
	bwtesting.BwRunTests(t, Int32Set.String, map[string]bwtesting.TestCaseStruct{"Int32Set.String": {
		In:  []interface{}{Int32Set{_Int32SetTestItemA: struct{}{}}},
		Out: []interface{}{bwjson.PrettyJson([]int32{_Int32SetTestItemA})},
	}})
	bwtesting.BwRunTests(t, Int32Set.DataForJSON, map[string]bwtesting.TestCaseStruct{"Int32Set.DataForJSON": {
		In:  []interface{}{Int32Set{_Int32SetTestItemA: struct{}{}}},
		Out: []interface{}{[]interface{}{_Int32SetTestItemA}},
	}})
