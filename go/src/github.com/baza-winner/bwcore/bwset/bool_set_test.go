// Code generated by "bwsetter -type=bool"; DO NOT EDIT; bwsetter: go get -type=bool -set=BoolSet -test -nosort%!(EXTRA string=github.com/baza-winner/bwcore/bwsetter)
