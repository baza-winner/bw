// Code generated by "setter -type=int"; DO NOT EDIT; setter: go get github.com/baza-winner/bwcore/setter
...
func TestIntSet(t *testing.T) {
	...
	bwtesting.BwRunTests(t, IntSet.String, map[string]bwtesting.TestCaseStruct{"IntSet.String": {
		In:  []interface{}{IntSet{_IntSetTestItemA: struct{}{}}},
		Out: []interface{}{fmt.Sprintf("[\n  %q\n]", strconv.FormatInt(int64(_IntSetTestItemA), 10))},
	}})
	bwtesting.BwRunTests(t, IntSet.GetDataForJson, map[string]bwtesting.TestCaseStruct{"IntSet.GetDataForJson": {
		In:  []interface{}{IntSet{_IntSetTestItemA: struct{}{}}},
		Out: []interface{}{[]interface{}{strconv.FormatInt(int64(_IntSetTestItemA), 10)}},
	}})
