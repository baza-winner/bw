...
func TestUint16Set(t *testing.T) {
	...
	bwtesting.BwRunTests(t, Uint16Set.String, map[string]bwtesting.TestCaseStruct{"Uint16Set.String": {
		In:  []interface{}{Uint16Set{_Uint16SetTestItemA: struct{}{}}},
		Out: []interface{}{fmt.Sprintf("[\n  %q\n]", strconv.FormatUint(uint64(_Uint16SetTestItemA), 10))},
	}})
	bwtesting.BwRunTests(t, Uint16Set.GetDataForJson, map[string]bwtesting.TestCaseStruct{"Uint16Set.GetDataForJson": {
		In:  []interface{}{Uint16Set{_Uint16SetTestItemA: struct{}{}}},
		Out: []interface{}{[]interface{}{strconv.FormatUint(uint64(_Uint16SetTestItemA), 10)}},
	}})
