// Code generated by "setter -type=uint"; DO NOT EDIT; setter: go get github.com/baza-winner/bwcore/setter
...
func TestUintSet(t *testing.T) {
	...
	bwtesting.BwRunTests(t, UintSet.String, map[string]bwtesting.TestCaseStruct{"UintSet.String": {
		In:  []interface{}{UintSet{_UintSetTestItemA: struct{}{}}},
		Out: []interface{}{fmt.Sprintf("[\n  %q\n]", strconv.FormatUint(uint64(_UintSetTestItemA), 10))},
	}})
	bwtesting.BwRunTests(t, UintSet.GetDataForJson, map[string]bwtesting.TestCaseStruct{"UintSet.GetDataForJson": {
		In:  []interface{}{UintSet{_UintSetTestItemA: struct{}{}}},
		Out: []interface{}{[]interface{}{strconv.FormatUint(uint64(_UintSetTestItemA), 10)}},
	}})
