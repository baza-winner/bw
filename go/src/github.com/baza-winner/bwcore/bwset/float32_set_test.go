// Code generated by "setter -type=float32"; DO NOT EDIT; setter: go get github.com/baza-winner/bwcore/setter
...
func TestFloat32Set(t *testing.T) {
	...
	bwtesting.BwRunTests(t, Float32Set.String, map[string]bwtesting.TestCaseStruct{"Float32Set.String": {
		In:  []interface{}{Float32Set{_Float32SetTestItemA: struct{}{}}},
		Out: []interface{}{fmt.Sprintf("[\n  %q\n]", strconv.FormatFloat(float64(_Float32SetTestItemA), byte(0x66), -1, 64))},
	}})
	bwtesting.BwRunTests(t, Float32Set.GetDataForJson, map[string]bwtesting.TestCaseStruct{"Float32Set.GetDataForJson": {
		In:  []interface{}{Float32Set{_Float32SetTestItemA: struct{}{}}},
		Out: []interface{}{[]interface{}{strconv.FormatFloat(float64(_Float32SetTestItemA), byte(0x66), -1, 64)}},
	}})
